# 🎙️ Voice-to-Contract (V2C) — for Four Speech AI

Voice-to-Contract (V2C) is a frictionless interface layer for the BSC ecosystem that allows users to execute smart contract operations using natural spoken language. Integrated with the Four Speech AI protocol, this module enables secure, intent-driven interactions with DeFi protocols — completely hands-free.
...
|-------------|----------------|--------|
| **Swap** | `Swap 100 USDC to BNB with 1% max slippage` | Calls `swapExactTokensForTokens` |
